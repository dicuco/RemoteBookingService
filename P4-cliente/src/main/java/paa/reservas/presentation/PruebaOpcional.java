...
/*
 * 
 * Este es el ejemplo que hay en el github para analizarlo y ver como funciona el codigo
 * 
 */

public class PruebaOpcional {
        ...
        jXMapKit.getMainMap().addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e)
            {
                ...
                if (screenPos.distance(e.getPoint()) < 20)
                {
                    ...
                    /*
                     * en vez de que nos muestres un tooltip(que muestra el nombre cuando lo pones encima)
                     * queremos que nos devuelva el hotel de la etiqueta seleccionada
                     */
